...
function MapLibrePostOfficeClusterPage() {
  ...
  return (
    <PostOfficeClusterPageContent
      mapViewState={mapViewState}
      renderMapView={(children, onMapClick) => (
        <MapLibreView state={mapViewState as MapLibreViewState} projection="mercator" onMapClick={onMapClick}>
          {children}
        </MapLibreView>
      )}
    />
...
function MapboxPostOfficeClusterPage() {
  ...
  return (
    <PostOfficeClusterPageContent
      mapViewState={mapViewState}
      renderMapView={(children, onMapClick) => (
        <MapboxView state={mapViewState as MapboxViewState} accessToken={accessToken} onMapClick={onMapClick}>
          {children}
        </MapboxView>
      )}
    />
...
function LeafletPostOfficeClusterPage() {
  ...
  return (
    <PostOfficeClusterPageContent
      mapViewState={mapViewState}
      renderMapView={(children, onMapClick) => (
        <LeafletMapView state={mapViewState as LeafletMapViewState} onMapClick={onMapClick}>
          {children}
        </LeafletMapView>
      )}
    />
...
function OpenLayersPostOfficeClusterPage() {
  ...
  return (
    <PostOfficeClusterPageContent
      mapViewState={mapViewState}
      renderMapView={(children, onMapClick) => (
        <OpenLayersMapView state={mapViewState as OpenLayersMapViewState} onMapClick={onMapClick}>
          {children}
        </OpenLayersMapView>
      )}
    />
...
function ArcGISPostOfficeClusterPage() {
  ...
  return (
    <PostOfficeClusterPageContent
      mapViewState={mapViewState}
      renderMapView={(children, onMapClick) => (
        <ArcGISMapView2D state={mapViewState as ArcGISViewState} onMapClick={onMapClick}>
          {children}
        </ArcGISMapView2D>
      )}
    />
