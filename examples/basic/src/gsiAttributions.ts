...
export const GSI_ATTRIBUTION = '<a href="https://maps.gsi.go.jp/development/ichiran.html" target="_blank" rel="noopener noreferrer">地理院タイル</a>';
export const GSI_RELIEF_ATTRIBUTION = '海域部は海上保安庁海洋情報部の資料を使用して作成';
export const GEBCO_ATTRIBUTION = 'The bathymetric contours are derived from those contained within the GEBCO Digital Atlas, published by the BODC on behalf of IOC and IHO (2003) (<a href="https://www.gebco.net" target="_blank" rel="noopener noreferrer">https://www.gebco.net</a>)';
