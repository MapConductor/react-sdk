...
const SAMPLE_PAGES: SamplePageDefinition[] = [
  ...
  { id: 'info-bubble-simple', label: 'Simple InfoBubble', group: 'InfoBubble' },
  { id: 'info-bubble-multiple', label: 'Multiple InfoBubbles', group: 'InfoBubble' },
  { id: 'info-bubble-rich', label: 'Rich InfoBubble', group: 'InfoBubble' },
  { id: 'info-bubble-styled', label: 'Styled InfoBubble', group: 'InfoBubble' },
