...
ask-to-commit "${ROOT_DIR}/react-for-arcgis"
ask-to-commit "${ROOT_DIR}/react-for-cesium"
ask-to-commit "${ROOT_DIR}/react-for-googlemaps"
ask-to-commit "${ROOT_DIR}/react-for-here"
ask-to-commit "${ROOT_DIR}/react-for-leaflet"
ask-to-commit "${ROOT_DIR}/react-for-mapbox"
ask-to-commit "${ROOT_DIR}/react-for-azuremaps"
ask-to-commit "${ROOT_DIR}/react-for-mapkit"
ask-to-commit "${ROOT_DIR}/react-for-maplibre"
ask-to-commit "${ROOT_DIR}/react-for-openlayers"
ask-to-commit "${ROOT_DIR}/react-geojson-layer"
ask-to-commit "${ROOT_DIR}/react-heatmap"
ask-to-commit "${ROOT_DIR}/react-icons"
ask-to-commit "${ROOT_DIR}/react-marker-clustering"
ask-to-commit "${ROOT_DIR}/reactnative-for-arcgis"
ask-to-commit "${ROOT_DIR}/reactnative-for-googlemaps"
ask-to-commit "${ROOT_DIR}/reactnative-for-maplibre"
ask-to-commit "${ROOT_DIR}/reactnative-for-here"
