...
__attribute__((constructor)) static void MCTemplateRegisterLegacyInterop(void)
{
  MCReactNativeRegisterLegacyViewManagerInterop(@"TemplateMapView");
}
