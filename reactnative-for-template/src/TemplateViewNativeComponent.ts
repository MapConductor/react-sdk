...
export type NativeTemplateViewEvent<T> = NativeMapViewEvent<T>;

/** その地図SDKにしかない prop（API キー等）はここに足す。 */
export interface NativeTemplateViewProps extends NativeMapViewProps {}
...
export default requireNativeComponent<NativeTemplateViewProps>(
  // android の MapConductorTemplateViewManager (REACT_CLASS) と
